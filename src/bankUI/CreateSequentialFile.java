...
public class CreateSequentialFile extends JFrame {
    ...
    public void addRecord() {
        ...
        char genderValue = ' ';
        double balance = 0;
        double transacionAmount = 0;
        AccountRecord record;
        String fieldValues[] = userInterface.getFieldValues();
        //String fieldGenderValues = fieldValues[BankUI.GENDER];
        ...
        if (!fieldValues[BankUI.ACCOUNT].equals("")) {
            ...
            try {
                ...
                balance = Double.parseDouble(fieldValues[BankUI.BALANCE]);
                transacionAmount = Double.parseDouble(fieldValues[BankUI.TRANSACTION]);
                genderValue = fieldValues[BankUI.GENDER].charAt(0);
